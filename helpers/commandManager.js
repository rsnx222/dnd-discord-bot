...
// Retry logic for batch registration with increased retries and exponential backoff
async function registerBatch(batch, DISCORD_CLIENT_ID, guildId, retries = 4, delayFactor = 2000) {
  try {
